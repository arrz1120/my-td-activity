...
{
    if (checkagree() && BlurPwd(true) && BlurImgCode(true) && BlurCode(true))
    {
        $(ctrl).unbind("click");
        ...
        $.ajax({
            ...
            data: {
                ...
                mmtoken: GetQueryString("mmtoken"),  //脉脉推广
                wps_userid: wps_userid,  //wps推广
                dec: wps_from //wps推广
            },
