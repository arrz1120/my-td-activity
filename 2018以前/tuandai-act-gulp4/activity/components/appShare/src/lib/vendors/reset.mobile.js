 ...
 *              scss 中 $ppr(pixel per rem) 变量写法 -- $ppr: 720px/16/1rem;
 *                      元素尺寸写法 -- html { font-size: $ppr*1rem; } body { width: 720px/$ppr; }。

 */
window.mobileUtils = (function (win, doc) {
