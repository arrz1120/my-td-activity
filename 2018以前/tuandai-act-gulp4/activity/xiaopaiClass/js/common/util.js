(function(global) {
    ...
    */
    function popup(options) {
        ...
        // if(_options.type === 'share'){
        //     alert_con.append(_options.content);
        // }else{
        //     var alert_box = $("<div/>").addClass("alert-box " + _options.conClassName);
        // }
        if(_options.type !== 'share'){
            var alert_box = $("<div/>").addClass("alert-box");
        }
        alert_container = _options.type === 'share' ? alert_con : alert_box;
        alert_container.append(_options.content);
        ...
        if (_options.btns.length > 1) {
            ...
            alert_container.append(cancel_btn).append(confirm_btn);
            ...
            alert_container.append(confirm_btn);
        }
        if(_options.type !== 'share'){
            alert_con.append(alert_container);
        }else{
            // alert_container.append(cls_btn);
        }
