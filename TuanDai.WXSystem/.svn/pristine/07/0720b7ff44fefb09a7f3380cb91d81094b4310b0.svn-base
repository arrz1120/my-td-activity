...
<body>
    ...
    <div class="bg-fff wh100">
        ...
        <div class="contentWrap pt20" id="loginConfirm">
            ...
            <div class="text-center f13px c-ababab mt8">我已阅读并同意<span class="f13px c-ffcf1f"><a href="<%=TuanDai.WXApiWeb.GlobalUtils.ContractViewUrl%>/p2p/weixin/contractagreement.aspx" class="f13px c-ffcf1f">《团贷网服务协议》</a></span>
    ...
    <script type="text/javascript">
        ...
        function getTime() {
            ...
            if (angle >= 61) {
                ...
                leftcircle.style.cssText = "transform: rotate(45deg)";
                if (second <= 0) {
                    clearInterval(timer);
                ...
                if (angle <= 30) {
                    rightcircle.style.cssText = "transform: rotate(45deg)";
                    leftcircle.style.cssText = "transform: rotate(" + (45 - angle * 6) + "deg)";
                } else {
                    rightcircle.style.cssText = "transform: rotate(" + (45 - (angle-30) * 6) + "deg)";
