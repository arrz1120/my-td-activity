...
<head>
    ...
    <script type="text/javascript">
        ...
        var totalMoney1 = "<%=model.CompleteAmount%>";
    </script>
    <style type="text/css">
...
<!--下拉刷新 Start-->  
 ...
 <!--借款人信息-->
    <div class="pr15 pt15 pb15 bb-d1d1d1 bg-fff">
        <div class="c-fab600 f15px pl15">借款方信息</div>
        <div class="info-item clearfix mt6">
	        <div class="info-l lf">
	            <p>借款方:<span class="c-212121"><%= BusinessDll.StringHandler.MaskStartPre(borrowUserInfo.RealName, 1) %></span></p>
	        </div>
	        <div class="info-r rf">
