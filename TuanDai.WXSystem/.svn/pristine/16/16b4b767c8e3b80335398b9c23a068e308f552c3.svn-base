<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reg_cgh.aspx.cs" Inherits="TuanDai.WXApiWeb.user.user2.reg_cgh" %>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
           ...
           $(".btn-reg").click(function () {
               ...
               $.ajax({
                   ...
                   data: {
                       ...
                       ucity: ucity, uopenname: uopenname, umobile: umobile
                   },
