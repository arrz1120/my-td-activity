...
document.write("<script src='/scripts/select_redbox.js?v=201706090001' type='text/javascript'></script>");
...
$(function () {
    ...
    var html = '<div class="coverBox invest-alert bg-fff hide" style="z-index:501;" id="invest_alert">' +
        ...
        '<div class="invest-alert-inp mt10">' +
    ...
    if (jsonData.IsZQZR == 1)
        html += '<a class="f12px c-fab600" href="/Contract/contractZqzr.html">《债权转让协议》</a>';
    else if (jsonData.ProjectType == 1 || jsonData.ProjectType == 3)
        html += '<a class="f12px c-fab600" href="/Contract/contractType1.html">《商友贷合同》</a>';
    else if (jsonData.ProjectType == 6)
        html += '<a class="f12px c-fab600" href="/Contract/contractType6.html">《借款合同》</a>';
    else if (jsonData.ProjectType == 9 || jsonData.ProjectType == 10 || jsonData.ProjectType == 11)
        html += '<a class="f12px c-fab600" href="/Contract/contractType11.html">《微团贷合同》</a>';
    else if (jsonData.ProjectType == 18)
        html += '<a class="f12px c-fab600" href="/Contract/contractType18_1.html">《私募宝借贷合同》</a>';
    else if (jsonData.ProjectType == 15) {
        if (jsonData.orgInfo != null && jsonData.orgInfo.OrgTypeId == 5) {
            if(jsonData.orgInfo.SubTypeId != 3)
                html += '<a class="f12px c-fab600" href="/Contract/contractType15_1.html">《借款合同》</a>';
            else
                html += '<a class="f12px c-fab600" href="/Contract/contractType15_2.html">《借款合同》</a>';
        } else {
            html += '<a class="f12px c-fab600" href="/Contract/contractType15_3.html">《借款合同》</a>';
        }
        
    } else if (jsonData.ProjectType == 19) {
        html += '<a class="f12px c-fab600" href="/Contract/contractType19.html?deadtype=' + deadType + '">《供应链专区服务协议》</a>';
    }
    else if (jsonData.ProjectType == 20)
        html += '<a class="f12px c-fab600" href="/Contract/contractType20.html?deadtype=' + deadType + '">《供应链金融协议》</a>';
    else if (jsonData.ProjectType == 22)
        html += '<a class="f12px c-fab600" href="/Contract/contractType22.html">《项目宝B类合同》</a>';
    else if (jsonData.ProjectType == 23)
        html += '<a class="f12px c-fab600" href="/Contract/contractType23.html">《项目宝A类合同》</a>';
    else if (jsonData.ProjectType == 24 || jsonData.ProjectType == 25)
        html += '<a class="f12px c-fab600" href="/Contract/contractType25.html">《正合普惠合同》</a>';
    else if (jsonData.ProjectType == 30)
        html += '<a class="f12px c-fab600" href="/Contract/contractType30.html">《极速借合同》</a>';
    else if (jsonData.ProjectType == 40)
        html += '<a class="f12px c-fab600" href="/Contract/contractType40.html">《一点车贷合同》</a>';
    else
        html += '<a class="f12px c-fab600" href="/Contract/contractType6.html">《借款合同》</a>';
    html += '</div>' +
