<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contractType28.aspx.cs" Inherits="TuanDai.WXApiWeb.Contract.contractType28" %>
    ...
    <div class="Contract_t">
     ...
     <div class="Contract_c">
        ...
        <p>
            ...
            3、借款利息：在合同规定的借款期内，年利率为<span><%=this.proModel.InterestRate.Value.ToString()%>%</span>。乙方如果不按期归还借款，导致丙方代为偿付乙方应还借款本金或本息时，自丙方垫付之日起丙方有权向乙方收取代为偿付所产生的所有费用。<br />
