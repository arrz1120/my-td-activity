<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jiekuandiscountPrivilege.aspx.cs" MasterPageFile="~/MVipWebStite.Master" Inherits="TuanDai.WXApiWeb.Member.MemberCenter.Privilege.jiekuandiscountPrivilege" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <body class="bg-f1f3f5">
        ...
        <section class="privMain">
            <div class="imgBox">
                <img src="/imgs/member/priv4.png"></div>
            ...
            <div class="pl15 pr15 mt10 bg-fff pb20 bb-e6e6e6 bt-e6e6e6">
                ...
                <p class="f13px c-808080 pt10">资产标管理费优惠。</p>
                <p class="f13px c-fab600 pt10 pb20">管理费＝借款金额 × 0.25%/月 × 借款月数</p>
                <div class="bm-table">
                    <table class="">
                        <tbody>
                            <tr>
                                <th class="bb-e6e6e6 br-e6e6e6-before">会员等级</th>
                                <th class="bb-e6e6e6">优惠</th>
                            </tr>
                            <tr class="bg-fff">
