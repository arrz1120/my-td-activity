<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="TuanDai.WXApiWeb.user.user.Login" %>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
	...
	<body>
        ...
        <a href="/user/user/reg_cgh.aspx?cgt=<%=Tool.WEBRequest.GetQueryString("cgt")==null?"": Tool.WEBRequest.GetQueryString("cgt")%>" class="reg_btn btn_1" id="reg_btn">马上注册</a>
        <a href="/user/user/reg_1.aspx?cgt=<%=Tool.WEBRequest.GetQueryString("cgt")==null?"": Tool.WEBRequest.GetQueryString("cgt")%>" class="login_btn btn_1" id="login_btn">登录</a>
	</body>
