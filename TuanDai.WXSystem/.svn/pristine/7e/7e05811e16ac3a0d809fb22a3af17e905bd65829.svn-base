<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contractType19.aspx.cs" Inherits="TuanDai.WXApiWeb.Contract.contractType19" %>
...
<header class="headerMain" id="header">
    ...
    <div class="Contract">
        ...
        <div class="Contract_t">
            <ul>
                ...
                <li>
                    <div>丙方（担保人）：<span><%=DanBaoCompany %></span></div>
                </li>
            </ul>
        </div>
        <div class="Contract_c">
            ...
            <p>
                一、借款条款<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1、借款金额：乙方因资金周转需要，现向甲方借款￥<span><%=submodel.Amount.Value.ToString("N") %></span>元（大写人民币：<span><%=Tool.ChineseNum.GetUpperMoney(Convert.ToDouble(submodel.Amount)) %>圆整</span>）<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2、借款期限：<span><%=proModel.Deadline %></span><%=proModel.DeadType.Value==1?"个月":"天" %>，自甲方出借之日起计算。<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3、借款利息：在合同规定的借款期内，年利率为<span><%=proModel.InterestRate %></span>%,乙方如果不按期归还借款导致丙方代为偿付应还借款本息或本金时，自丙方垫付之日起，乙方除向丙方支付上述标准的利息（年利率折算成天计算）外还应额外承担垫付金额每日万分之三的违约金。<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4、还款方式：<span><%=RepaymentTypeDesc %></span>。</p>
            <p>
                二、保证担保<br />
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4、甲、乙、丙三方协商一致，可以变更合同。如果甲乙双方未经丙方同意擅自变更合<br />
              </p>
        </div>
    </div>
    ...
    <div class="Contract">
        <div class="Contract_c">
            <p>
                同的，则变更合同对丙方不发生效力，自合同变更之日起，丙方不再承担保证责任。<br/>
                三、追索费用<br />
        ...
        <div class="Contract_b">
            ...
            <p>
             ...
             <p style="margin-top:-170px;padding-left:20px;">
                <img src="<%=DanBaoImage %>"  style="width:177px;height:177px;"/> 
             </p> 
        </div>
    </div>
