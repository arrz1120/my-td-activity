<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contractType40.aspx.cs" Inherits="TuanDai.WXApiWeb.Contract.contractType40" %>
 <!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<header class="headerMain" id="header">
    ...
    <div class="Contract">
        ...
        <div class="Contract_t">
            <ul>
                ...
                <li>
                    ...
                    <div>身份证号码：<span><%=publisherModel.IdentityCard %></span></div>
                </li>
                <li>
        ...
        <div class="Contract_c">
            <p>
                特别提示：<br />
              甲、乙、丙三方请认真仔细阅读本合同项下的全部条款，甲、乙、丙三方一旦签订本合同，即视为三方已充分理解并完全同意本合同项下的所有条款及内容。甲、乙、丙三方通过<%=companyName %>（以下简称“团贷网”）的网站平台（以下简称“团贷网平台”），在平等自愿、协商一致的基础上，达成如下借款合同，以兹共同遵守执行。</p>
            <p>
                一、借款条款<br />
                ...
                3、借款利息：在合同规定的借款期内，年利率为<span><%=proModel.InterestRate %>%</span>。乙方如果不按期归还借款，导致丙方代为偿付乙方应还借款本金或本息时，自丙方垫付之日起丙方有权向乙方收取代为偿付所产生的所有费用。<br />
            ...
            <p>
                二、保证担保<br />
                1、乙方应向丙方支付担保费用并且向团贷网支付服务费用，在乙方足额支付上述费用后，丙方愿意按照本合同的约定为本合同项下的借款本金或本息（垫付标准依据甲方出借时其在团贷网平台的会员等级制度为准）提供连带保证责任。<br />
               2、乙方到期未及时归还甲方出借之本息，丙方应及时承担保证责任，垫付标准以甲方借款时其在团贷网平台的会员等级制度执行。若甲方出借时为普通会员，则出现前述情况下丙方仅向甲方垫付借款本金；若甲方出借时为超级会员，出现上述情况下丙方全额垫付本息。<br />
