                    ...
                    <div class="swiper-slide">
                        <div class="mission_box">
                            ...
                            <div class="mission_item clearfix">
                                ...
                                <div class="rf"><a href="https://at.tuandai.com/201708/invite/weixin/index.aspx?tdsource=tuanbirenwu<%=IsApp?"&type=mobileapp&t="+Tool.WEBRequest.GetString("t"):"" %>" class="block f14px c-ffffff text-center">去邀请</a></div>
                            </div>
