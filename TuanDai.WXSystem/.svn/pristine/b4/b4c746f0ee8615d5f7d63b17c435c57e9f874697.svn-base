...
namespace TuanDai.WXApiWeb.Member.fundStatisticsOld
{
    public partial class incomeCount : AppActivityBasePage
    {
        ...
        {
            //var model = WXFundClient.GetFundStatistData(userId);
        ...
        public void GetWe_FundAccountInfo(Guid userId)
       {
        ...
        /// 获取累计提现
        /// </summary>
        protected void GetTotalWithDrawal(Guid userId)
        {
        ...
        protected class CommissionApiResponse<T>
        {
        ...
        protected class EarnMoneyResponse
        {
