<%@ Page Language="C#" AutoEventWireup="true" CodeFile="incomeCount.aspx.cs" Inherits="TuanDai.WXApiWeb.Member.fundStatisticsOld.incomeCount" %>
...
<html>
	...
	<head>
		...
		<title>资金统计</title>
		<link rel="stylesheet" type="text/css" href="/Member/fundStatisticsOld/css/fundStatistics.css?v=<%=GlobalUtils.Version %>" />
		<link rel="stylesheet" type="text/css" href="/Member/fundStatisticsOld/css/swiper-3.4.0.min.css?v=<%=GlobalUtils.Version %>" />
	</head>
	...
	<script src="/Member/fundStatisticsOld/js/swiper-3.4.0.jquery.min.js?v=<%=GlobalUtils.Version %>" type="text/javascript" charset="utf-8"></script>
	<script src="/Member/fundStatisticsOld/js/script.js?v=<%=GlobalUtils.Version %>" type="text/javascript" charset="utf-8"></script>
