<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvestApp.aspx.cs" Inherits="TuanDai.WXApiWeb.Activity.inviteGetgift.InvestApp" %>
    ...
    <section class="condition-box">
        ...
        <div class="main-cn condition-cn position-relative">
            ...
            <div class="condition-d">
                ...
                <div class="invest-but"><a href="<%=this.IsValidRealName?"ToAppInvestList":"javascript: RealNameValidShow();" %>">马上投资</a></div>
            </div>
