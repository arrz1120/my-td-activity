<%@ WebHandler Language="C#"   Class="TuanDai.WXApiWeb.Activity.ExperienceGold.ImageCode" %>
...
namespace TuanDai.WXApiWeb.Activity.ExperienceGold
{
    ...
    public class ImageCode : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            #endregion
            context.Session["webcheckcodereg"] = checkCode;
            CookieHelper.WriteCookie("WX_Code01", Encryption.MD5(checkCode.ToLower()));
