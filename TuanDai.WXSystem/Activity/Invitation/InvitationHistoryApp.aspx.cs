...
{
    public partial class InvitationHistoryApp : System.Web.UI.Page
    {
        /// <summary>
        /// 抽奖总次数.
        /// </summary>
        ...
        public string SourceType
        {
            get
            {
                return Tool.WEBRequest.GetString("type","App").ToLower();
            }
        }

        protected void Page_Load(object sender, EventArgs e)
        {
            if (!WebUserAuth.IsAuthenticated && SourceType=="app")
            {
                Response.Redirect("activity/Invitation/ToAppLogin");
                return;
            }
