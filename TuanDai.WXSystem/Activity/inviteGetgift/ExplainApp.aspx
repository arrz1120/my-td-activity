<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExplainApp.aspx.cs" Inherits="TuanDai.WXApiWeb.Activity.inviteGetgift.ExplainApp" %>
...
<head>
    ...
    <script src="js/validApp.js?v=20150917001"></script>
</head>
    ...
    <section class="explain-box">
        <div class="explain-cn main-cn clearfix">
            ...
            <div class="explain-text fr">
                <p class="fz10"><span class="fz12">使用说明：</span>了一些投资红包和体验金，分享给你体验一下~~收益还挺高的！</p>
                <div class="use mt10 clearfix">
                    <a href="<%=this.IsValidRealName?"ToAppInvestList":"javascript: RealNameValidShow();" %>" class="fz12 fr">马上使用</a>
                </div>
            </div>
        </div>
