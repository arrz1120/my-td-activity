<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Gift.aspx.cs" Inherits="TuanDai.WXApiWeb.Activity.inviteGetgift.Gift" %>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/page.css?v=20150915">
    <style type="text/css">
        body, html {
            width: 100%;
            height: 100%;
...
<body class="giftbg">
    <section class="giftBox">
        ...
        <div class="nub-inp">
            <div class="code-box">
             ...
             <input type="text" class="pos-a pos-num" placeholder="请输入手机号" id="phone" maxlength="11" onkeydown="checkPhone()"/>
        
                          </div>
            <div class="error" id="dvPhoneError" style="display:none;">&nbsp;</div>
         <div class="yanzhengma">
             <div class="code-cn pos-r" style="display:none;">
                 <input type="text" class="pos-a" placeholder="请输入图形验证码" id="txtValidNumber" maxlength="4"/>
             ...
             <div class="code-cn pos-r"  style="display:none;">
                 <input type="text" class="pos-a" placeholder="请输入手机验证码"  id="messCode" maxlength="6"/>
            ...
            <a href="javascript:;" class="btn" id="btnReg"><img src="imgs/gift-btn.png"/>
         </a>
        </div>
        </div>
    ...
    <script src="js/reg.js?v=20150917002" type="text/javascript"></script>
