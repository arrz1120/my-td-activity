...
{
    public partial class ContractJzdb : AppActivityBasePage 
    {
        /// <summary>
        /// 合同编号
        /// </summary>
        ...
        /// 标信息
        /// </summary>
        protected ProjectDetailInfo proModel=new ProjectDetailInfo ();
        /// <summary>
        /// 申购表
        /// </summary>
        protected SubscribeInfo submodel=new SubscribeInfo ();
        ...
        /// 借款人信息
        /// </summary>
        protected UserBasicInfoInfo publisherModel=new UserBasicInfoInfo ();
        ...
        /// 担保机构 
        /// </summary>
        protected AssureOrganizationInfo AssureModel = new AssureOrganizationInfo();
        ...
        private void GetContractInfo(string key)
        {
            ...
            PrincipalInterest = submodel.Amount.Value + submodel.InterestAmount.Value;
