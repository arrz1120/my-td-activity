<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contractType20.aspx.cs" Inherits="TuanDai.WXApiWeb.Contract.contractType20" %>
    ...
    <div class="Contract">
        ...
        <div class="Contract_t">
            <ul>
                ...
                <li>
                    <div>丙方（担保人）：<span>东莞市江辉非融资性担保有限公司</span></div>
                </li>
            </ul>
        </div>
        ...
        <div class="Contract_b">
            ...
            <p>
             ...
             <p style="margin-top:-170px;padding-left:20px;">
                <img src="http://image.tuandai.com/EnterpriseImage/hetongzhang/jianghuinew.png"  style="width:177px;height:177px;"/> 
             </p> 
        </div>
    </div>
