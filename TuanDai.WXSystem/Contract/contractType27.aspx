<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contractType27.aspx.cs" Inherits="TuanDai.WXApiWeb.Contract.contractType27" %>
    ...
    <div class="Contract_t">
     ...
     <div class="Contract_c">
        ...
        <p>
            ...
            3、借款利息：在合同规定的借款期内，年利率为<span><%=this.proModel.InterestRate.Value.ToString()%>%</span>。乙方如果不按期归还借款导致丙方代为偿付应还借款本息或本金时，自丙方垫付之日起，乙方除向丙方支付上述标准的利息（年利率折算成天计算）外还应额外承担垫付金额每日万分之三的违约金。<br />
