<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="giftPrivilege.aspx.cs" MasterPageFile="~/MVipWebStite.Master" Inherits="TuanDai.WXApiWeb.Member.MemberCenter.Privilege.giftPrivilege" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <body class="bg-f1f3f5">
        ...
        <section class="privMain">
            <div class="imgBox">
                <img src="/imgs/member/priv3.png"></div>
            <div class="bt-e6e6e6 bb-e6e6e6 nav-box">
                <div class="clearfix nav ">
                    <div class="lf">
                        <p class="f17px c-808080 p-pri"><%=vipInfo.Level>=4?"已获取特权":"未获得特权" %></p>
                    </div>
            ...
            <div class="pl15 pr15 mt10 bg-fff pb20 bb-e6e6e6 bt-e6e6e6">
                ...
                <p class="f13px c-808080 pt10 pb20">每逢中秋、端午等传统节日可获赠精美贺礼一份。</p>
                <div class="bm-table">
                    <table class="">
                        <tbody>
                            <tr>
