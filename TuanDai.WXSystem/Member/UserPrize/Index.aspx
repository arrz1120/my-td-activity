...
<%@ Import Namespace="TuanDai.WXApiWeb.Activity.Minions2" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body class="bg-f1f3f5">
    ...
    <section class="bb-e6e6e6 bg-fff click-respond">
    ...
    <%if(Prize9>=0) { %>
    <section class="bb-e6e6e6 bg-fff click-respond">
        <div class="bb-e6e6e6" onclick="javascript:window.location='freezqzr.aspx'">
            <div class="safetyBox3 clearfix">
                <div class="lf c-212121 f17px lh22 clearfix"><i class="icoBox30 ico-zzq"></i>免费债转券</div>
                <div class="rf clearfix"><span class="f15px c-ababab lh22"><%=this.Prize9%>张<i class="box-arrow-r mt-1"></i></span></div>
            </div>
        </div>
    </section>
    <%} %>
    <section class="bb-e6e6e6 bg-fff click-respond" onclick="javascript:window.location='gift.aspx'">
        <div class="safetyBox3 clearfix">
    ...
    <section class="bt-e6e6e6 bb-e6e6e6 bg-fff" onclick="JAVASCRIPT:window.location.href='jdquan.aspx';">
        <div class="safetyBox clearfix">
            <div class="lf c-212121 f17px clearfix">
                <i class="icoBox30 ico-zgq"></i>资格券</div>
            <div class="rf clearfix">
                <span class="f15px  c-ababab lh22"><%=this.Prize10 %>张
                    <i class="box-arrow-r mt-1"></i>
                </span>
            </div>
        </div>
    </section>
