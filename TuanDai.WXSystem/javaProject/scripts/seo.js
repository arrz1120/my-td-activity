	...
	if(document.URL.indexOf("Register.aspx")!=-1 || document.URL.indexOf("Login.aspx")!=-1 ){
    	...
    	var footer = '<footer>' + 
			...
			'<div class="bottom ">' + 
				...
				'</div>' + 
				'<p class="copyright c-ababab f11px text-center mt13">2010-'+new Date().getFullYear()+' © 团贷网 粤ICP备12043601号-1</p>' +
			'</div>' +
		'</footer>';
...
function buildNav(){
	var nav = '<div class="normalAlert moveToLeft hide" id="glAlert">'+
			'<header class="bkTop bb-e6e6e6">'+
				'<h1 class="logo"><img src="http://bk.tuandai.com/img/logo.png" alt="团贷网"></h1>'+
				'<div class="top_right clearfix">'+
				...
				*/
				'<div class="pt25">'+
					'<div class="clearfix">'+
						...
						'</a>'+
						'<a href="http://bk.tuandai.com/licai/" class="block w33p lf text-center">'+
					...
					'<div class="clearfix pt20">'+
						...
						'</a>'+
						'<a href="https://m.tuandai.com/pages/downOpenApp.aspx?type=weixinapp" rel="nofollow" class="block w33p lf text-center">'+
							'<div class="seo_ico seo_ico9"></div>'+
							'<p class="f14px c-333333 mt6">官方app</p>'+
						'</a>'+
					'</div>'+
				'</div>'+
			'</div>'+
