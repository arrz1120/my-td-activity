(function() {
	...
	function init() {
	    ...
	    Jsbridge.rightButtonClick(function () {
	        ...
	        window.location.href = "investList.aspx?extendkey=" + Util.getParam('extendkey');  //"./investList.html";
	    });
					...
					if (list && list.length > 0) {
						...
						list.forEach(function(item, index) {
							...
							temp += ' <li class="c-row"><div class="c-date">' + time +
								'</div><div class="c-num">' + item.EarnMoney + '<span class="">' + item.sendEarnStatusText + '</span>' + '</div></li>';
						});
