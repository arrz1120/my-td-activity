	...
	<div class="mt15 bt-e6e6e6 bb-e6e6e6">
		...
		<div class="bg-fff moveTop" id="ruleCon1">
			<div class="bb-e6e6e6 ml15 pb15 pr15">
				<p class="pt13 f14px c-212121">参考年回报率</p>
				<p class="pt10 c-808080 f14px text-justify"><%= ToolStatus.DeleteZero(model.YearRate) %>%（本息复投）/<%= ToolStatus.DeleteZero(model.MaxYearRate2) %>%（本金复投），参考年回报率非实际年化收益率，根据系统自动投标的投资时间、标的期限、满标情况的不同，实际年化收益率可能有上下小许浮动。</p>
			</div>
			<div class="bb-e6e6e6 ml15 pb15 pr15">
 ...
 <div class="hide"  id="dvTips">
    <div class="alert webkit-box box-center">
	    <div class="bg-fff alert-con" id="alertCon">
		    <p class="text-center c-212121 f17px fb ">参考年回报率说明</p>
		    <p class="pt12 f15px c-808080 text-justify pl20 pr20">参考年回报率非实际年化收益率，根据系统自动投标的投资时间、标的期限、满标情况的不同，实际年化收益率可能有上下小许浮动。</p>
