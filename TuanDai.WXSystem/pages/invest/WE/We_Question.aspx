<%@ Page Language="C#" AutoEventWireup="true" CodeFile="We_Question.aspx.cs" Inherits="TuanDai.WXApiWeb.pages.invest.WE.We_Question" %>
...
<div class="questionWrap bg-fff">
	<ul>
		...
		<li>
			...
			<div class="question-txt bb-e6e6e6 bg-f6f7f8 pd15 hide">
				<p class="c-808080 f15px text-justify">We计划[分期宝]的复投方式有：本息复投、本金复投两种。本息复投为每月回款的本金和参考回报全部用于复投；本金复投为每月回款本金用于复投，参考回报提取至账户可用余额。投资者在加入We计划[分期宝]时可选择复投方式，加入成功后暂不支持修改</p>
			</div>
		</li>
		<li>
		...
		<li>
			...
			<div class="question-txt bt-e6e6e6 bg-f6f7f8 pd15 hide">
				<p class="c-808080 f15px text-justify">持有满3个月（自资金锁定期结束次日起算）即可申请转让提前退出计划，转让完成时间视市场交易情况而定。目前仅支持全额（本金+已获参考回报）提前退出，不支持部分退出。</p>
		...
		<li>
			...
			<div class="question-txt bt-e6e6e6 bg-f6f7f8 pd15 hide">
				...
				<p class="c-808080 f15px text-justify">② 提前退出：持有满3个月（自资金锁定期结束次日起算）即可申请转让提前退出计划，转让完成时间视市场交易情况而定。目前仅支持全额（本金+已获参考回报）提前退出，不支持部分退出。申请提前退出至转让成功前一日仍然计息；若同一笔资金分多次转让成功，则转让期间未转让部分资金计息，已转让部分资金不再计息。</p>
		...
		<li>
			<div class="question-tit pl15 clearfix pb18 pt18" style="">
				<i class="icon-triagle-r rotateZ0 lf mt6"></i>
				<p class="c-212121 f17px pl20 pr15 text-justify">为什么实际参考回报与预期参考回报可能有上下小许浮动？</p>
			</div>
			<div class="question-txt bt-e6e6e6 bg-f6f7f8 pd15 hide">
				<p class="c-808080 f15px text-justify">实际参考回报会因投资时间、投资标的期限、满标情况的不同可能与预期参考回报存在上下小许浮动；在实际参考回报有上下浮动的情况下，以实际参考回报为准。</p>
			</div>
		</li>
		<li>
			<div class="question-tit bb-e6e6e6 pl15 pt18 pb18">
			...
			<div class="question-txt bb-e6e6e6 bg-f6f7f8 pd15 hide">
				<p class="c-808080 f15px text-justify">团贷网以严谨负责的态度对每笔借款进行严格筛选。同时，We计划所投资项目适用于安全保障体系。</p>
			</div>
		</li>
  ...
  <%  }else if (IsWeNewHand)
	...
	<ul>
        ...
        <li>
			<div class="question-tit bb-e6e6e6 pl15 pt18 pb18">
				<p class="c-212121 f17px"><i class="icon-triagle-r rotateZ90"></i>投资者加入新手专享复投宝后，如何计算持续享有新手专享复投宝服务的参考回报？</p>
			</div>
			<div class="question-txt bb-e6e6e6 bg-f6f7f8 pd15">
				<p class="c-808080 f15px text-justify">投资者享有新手专享复投宝服务的参考回报按照：加入金额 * 参考年回报率 * 持续服务期/12（持续服务期以月为单位）或加入金额 * 参考年回报率 * 持续服务期/365（持续服务期以天为单位）计算。</p>
                <p>举例说明：</p>
                <p>加入3个月的新手专享复投宝10000元，对应参考回报：10000*13%*3/12=325；</p>
                <p>加入15天的新手专享复投宝10000元，对应参考回报：10000*11%*15/365=45.20。</p>
			</div>
		</li>
		<!--2-->
        <li>
			<div class="question-tit pl15 clearfix pb18 pt18" style="">
				<i class="icon-triagle-r rotateZ0 lf mt6"></i>
				<p class="c-212121 f17px pl20 pr15 text-justify">新手专享复投宝智能投资服务安全吗？</p>
			</div>
			<div class="question-txt bt-e6e6e6 bg-f6f7f8 pd15 hide">
				<p class="c-808080 f15px text-justify">加入新手专享复投宝智能投资服务后，其所投标的适用于安全保障计划。</p>
			</div>
		</li> 
		<!--3--> 
        <li>
		    <div class="question-tit pl15 clearfix pb18 pt18" style="">
			    <i class="icon-triagle-r rotateZ0 lf mt6"></i>
			    <p class="c-212121 f17px pl20 pr15 text-justify">如何结束新手专享复投宝服务？</p>
		    </div>
		    <div class="question-txt bt-e6e6e6 bg-f6f7f8 pd15 hide">
			    <p class="c-808080 f15px text-justify">投资者持续享有新手专享复投宝服务<%=model.Deadline+(model.DeadType==2?"天":"个月") %>后可结束服务，结束服务完成时间视市场交易情况而定，结束服务时以参考年回报率计算参考回报。</p>
		    </div>
		</li> 
		<!--4--> 
        <li>
		    ...
		    <div class="question-txt bt-e6e6e6 bg-f6f7f8 pd15 hide">
			    <p class="c-808080 f15px text-justify">结束新手专享复投宝服务时如实际收益高于参考回报，超出部分作为平台服务费由平台收取。</p>
		    </div>
		</li> 
		<!--5--> 
        <li>
		    <div class="question-tit pl15 clearfix pb18 pt18" style="">
			    <i class="icon-triagle-r rotateZ0 lf mt6"></i>
			    <p class="c-212121 f17px pl20 pr15 text-justify">为什么新手专享复投宝的持续服务期是<%=model.Deadline+(model.DeadType==2?"天":"个月") %>，投资标的借款期限不一定是<%=model.Deadline+(model.DeadType==2?"天":"个月") %>呢？</p>
		    </div>
		    <div class="question-txt bt-e6e6e6 bg-f6f7f8 pd15 hide">
			    <p class="c-808080 f15px text-justify">新手专享复投宝所投标的借款期限与持续服务期无关，如所投标的借款期限比<%=model.Deadline+(model.DeadType==2?"天":"个月") %>长，系统会在持续服务期到期时帮您退出债权；如所投标的借款期限比<%=model.Deadline+(model.DeadType==2?"天":"个月") %>短，系统会在标的到期后自动帮您匹配新的标的。</p>
		    </div>
		</li> 
		<!--6--> 
        <li>
		    <div class="question-tit pl15 clearfix pb18 pt18" style="">
			    <i class="icon-triagle-r rotateZ0 lf mt6"></i>
			    <p class="c-212121 f17px pl20 pr15 text-justify">新手专享复投宝的持续服务期从哪一日开始？</p>
		    </div>
		    <div class="question-txt bt-e6e6e6 bg-f6f7f8 pd15 hide">
			    <p class="c-808080 f15px text-justify">新手专享复投宝的持续服务期自加入之日起算。</p>
		    </div>
		</li> 
		<!--7--> 
        <li>
		    <div class="question-tit pl15 clearfix pb18 pt18" style="">
			    <i class="icon-triagle-r rotateZ0 lf mt6"></i>
			    <p class="c-212121 f17px pl20 pr15 text-justify">加入新手专享复投宝后，相应的待收和智享额度什么时候会增加？</p>
		    </div>
		    <div class="question-txt bt-e6e6e6 bg-f6f7f8 pd15 hide">
			    <p class="c-808080 f15px text-justify">投资者加入新手专享复投宝后，相应的待收和智享额度按参考年回报率计算，系统会在投资者加入新手专享复投宝后即增加相应的待收和智享额度。</p>
		    </div>
		</li> 
        <li>
		    <div class="question-tit pl15 clearfix pb18 pt18" style="">
		    ...
		    <div class="question-txt bt-e6e6e6 bg-f6f7f8 pd15 hide">
			    <p class="c-808080 f15px text-justify">投资者加入新手专享复投宝后，相应的团币会在投资者加入后按加入金额计算并发放。</p>
		    </div>
		</li> 
        <div class="pt15 bg-f6f7f8 bt-e6e6e6"></div>
	</ul>
...
<div class="questionWrap bg-fff">
	<ul>
        ...
        <li>
			...
			<div class="question-txt bb-e6e6e6 bg-f6f7f8 pd15">
				<p class="c-808080 f15px text-justify">目前，团贷网推出的We计划期限分别为3、6、12和24个月，后期会根据实际情况推出更多期限产品供投资者选择。</p>
			</div>
		</li>
		<!--2-->
        <li>
        ...
        <li>
		    ...
		    <div class="question-txt bt-e6e6e6 bg-f6f7f8 pd15 hide">
			    <p class="c-808080 f15px text-justify">We计划起息日自资金实际投资标的完成当日起算。</p>
		    </div>
		</li> 
		<!--5--> 
        <li>
