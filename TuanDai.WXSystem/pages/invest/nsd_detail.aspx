<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nsd_detail.aspx.cs" Inherits="TuanDai.WXApiWeb.pages.invest.nsd_detail" %>
...
<div class="dropContainer"> 
		...
		<div class="bt-e6e6e6 bb-e6e6e6 bg-fff mt15 pl15">
			...
			<div class="dropdownCon hide">
                ...
                <p class="pb15 c-808080 f14px pt15" >本项目专注三农产业链金融，通过整合上游厂商及供应商的优势产品资源，为农户提供采购优质产品、线上记录生产数据、线下标准化种植养殖系列服务。通过嵌入的金融服务解决农户贷款难的难题，有效缓解农户生产过程中的资金压力。
                </p>
                <p class="pb15 c-808080 f14px pt15">借款用途：用于农户生产过程中的饲料的采购。</p>
				</div>
			</div>
		</div>
		...
		<div class="bt-e6e6e6 bb-e6e6e6 bg-fff mt15 pl15">
			...
			<div class="dropdownCon hide">
				<div class="pb15 c-808080 f14px text-justify pr15 span_txt pos-r">①经营收入是本项目主要还款来源，农户收入状况良好，还款能力强；</div>
				<div class="pb15 c-808080 f14px text-justify pr15 span_txt pos-r">②农户经营数据预警系统，通过物联网监控生产过程中的指标数据，保障还款能力；</div>
                <div class="pb15 c-808080 f14px text-justify pr15 span_txt pos-r">③渠道线下监督体系、催收体系，提升催收业务成功率及风险预警能力；</div>
                <div class="pb15 c-808080 f14px text-justify pr15 span_txt pos-r">④合作渠道担保系统，保障相关资产的处置能力；</div>
