...
+function ($) {
    ...
    $('#page-city-picker').on('click', ' .modal-overlay, .popup-overlay, .close-popup, .open-popup, .close-picker', handleClicks);
...
+function($) {
    ...
    if ($.smConfig.showPageLoadingIndicator) {
       ...
       $('#page-city-picker').on('pageLoadStart', function() {
            $.showIndicator();

        });
       $('#page-city-picker').on('pageAnimationStart', function() {
            $.hideIndicator();
        });
       $('#page-city-picker').on('pageLoadCancel', function() {
            $.hideIndicator();
        });
       $('#page-city-picker').on('pageLoadComplete', function() {
            $.hideIndicator();
        });
       $('#page-city-picker').on('pageLoadError', function() {
            $.hideIndicator();
            $.toast('加载失败');
        });
    }
