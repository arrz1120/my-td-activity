<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reg_1.aspx.cs" Inherits="TuanDai.WXApiWeb.user.user.reg_1" %>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
           ...
           $.ajax({
               ...
               success: function (jsondata) {
                   ...
                   if (data == "1") {
                       ...
                       $('#error').html('');
                       $('#error').hide();
                       window.location.href = "/user/user/change_msg_1.aspx?telno=" + mobileNumber;
                   }
                   else {
                       //$("body").showMessage({ message: "手机已注册!", showCancel: false });
