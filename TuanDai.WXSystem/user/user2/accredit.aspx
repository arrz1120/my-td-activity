<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="accredit.aspx.cs" Inherits="TuanDai.WXApiWeb.user.user2.accredit" %>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
	  ...
	  <p class="reg_cgh">为了让您后续的借款及还款更加便捷，请您先进行以下授权：</p>
	   <ul class="select_list">
	   	...
	   	<li><span class='select_icon'></span> <p class="text">自动提现<span>（适用于企业及业务相关用户）</span></p></li>
	   </ul>	
    ...
    $(function () {
        ...
        $("#accredit_btn").click(function () {
            $.ajax({
                ...
                dataType: "json",
                data: {
                    cmd: "USER_AUTHORIZATION", TypeId: isshow,opertype:2
                },
