<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="seccessful.aspx.cs" Inherits="TuanDai.WXApiWeb.user.user2.seccessful" %>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
    ...
    <p class="congratulation">恭喜您，注册成功！</p>
		...
		<a href="http://weixin.hao8dai.com" id="j_close">马上关闭</a>
	</div>
	<script src="/scripts/jquery.min.js"></script>
	<script>
		$(function(){
			var rUrl="http://weixin.hao8dai.com";
